  ...
  const toggleConfirmPasswordVisibility = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                handleShow('Password Changed Successfully');
            } else {
        ...
        <Container style={{ border: '2px solid black', padding: '20px', borderRadius: '5px', marginTop: '100px', maxWidth: '500px' }}>
          <Row className="justify-content-md-center">
            <Col md="auto">
              <Form onSubmit={handleSubmit}>
                <Form.Group controlId="formRollNo">
                  ...
                  <Form.Control required type="text" value={rollno} onChange={(e) => setRollno(e.target.value)} />
                </Form.Group>
    
                <Form.Group controlId="formFathersNumber">
                  <Form.Label>Father's Number:</Form.Label>
                  <Form.Control required type="text" value={fathernumber} onChange={(e) => setFathernumber(e.target.value)} />
                </Form.Group>
    
                <Form.Group controlId="formPassword" className="position-relative">
              <Form.Label>Password:</Form.Label>
              <Form.Control required type={passwordShown ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} />
            ...
            <Form.Group controlId="formConfirmPassword" className="position-relative">
              ...
              <Form.Control required type={confirmPasswordShown ? "text" : "password"} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
