...
function StudentCompare() {
    ...
    return (
        <div>
            <AdminHeader/>
            <div className="details-container" style={{display: "flex", justifyContent: "space-between", marginLeft: "20px", marginTop: "30px", height: "auto", width: "100%"}}>
            <div className="cmp-data" style={{textAlign: "left", borderColor: "black", padding: "20px", borderRight: "2px solid black"}}>
                <h1 style={{ margin: 0 }}>
                    <span>C</span>
            ...
            <div className="std-data" style={{width: "65%"}}>
            <h1 style={{ margin: 0 }}>
                    <span>S</span>
